...
public abstract class AbstractDeclClass extends Tree {
    ...
    public abstract void insertionClassTableMethodes(DecacCompiler compiler);

    public abstract void genCodeInitializationChampsEtMethodes(DecacCompiler compiler);
